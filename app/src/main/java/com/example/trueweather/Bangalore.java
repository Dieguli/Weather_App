...
public class Bangalore extends AppCompatActivity {
    ...
    TextView temp, maxtemp,mintmep,humidity,descriptionban;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descriptionban = findViewById(R.id.descriptionban);
        imageView = findViewById(R.id.imageView);

        new GetWeather().execute(Connection.apiInfoOne(latban,lonban));
    }


    private class GetWeather extends AsyncTask<String ,Void,String> {

        ProgressDialog mProgressDialog = new ProgressDialog(Bangalore.this);
        ...
        protected void onPostExecute(String s) {
            ...
            descriptionban.setText(String.format("%s",info.getWeather().get(0).getDescription()));
            Picasso.with(Bangalore.this)
